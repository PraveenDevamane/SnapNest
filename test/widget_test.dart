...
// Simple, self-contained counter widget used for tests. This avoids
// initializing the whole app (which requires Firebase) and makes the
...
void main() {
  testWidgets('Counter increments smoke test', (WidgetTester tester) async {
    // Build our small counter app and trigger a frame.
